...
async function CalvasMain() {
  ...
  const vertex_shader_src = await (await fetch("TextRenderingWebGL/vertex.glsl")).text()
  const fragment_shader_src = await (await fetch("TextRenderingWebGL/fragment.glsl")).text()
  ...
  const image_textures = [
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Front.
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Back.
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Top.
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Bottom.
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Right.
    LoadImageTexture(gl, "TextRenderingWebGL/wooden-crate.webp"), // Left.
  ]
  ...
  const commands_per_face = [
    await StringToCommands(
      'Hello\nJetBrains\nMono!',
      'TextRenderingWebGL/jetbrainsmono_ttf/JetBrainsMonoNL-Regular.ttf',
      0,
      100,
      18
    ),
    await StringToCommands(
      'Hello\nInter!',
      'TextRenderingWebGL/inter_ttf/Inter_24pt-Regular.ttf',
      0,
      100,
      28
    ),
