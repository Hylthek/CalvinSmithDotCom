...
<div class="model-viewer-flex-container">
    ...
    <model-viewer class="model-viewer" src="/SteelBridge/BridgeModel.gltf" ar ar-modes="webxr scene-viewer quick-look" camera-controls tone-mapping="neutral" poster="/ImuMouse/Hourglass.webp" shadow-intensity="1" exposure="0.3"> </model-viewer>
</div>
...
<div class="flex-container">
    ...
    <div class="flex-object flex-container" style="flex-direction:column; flex: 1.5;">
        <img tabindex="1" class="flex-object" alt="Example Loading" src="/SteelBridge/Loading.webp" title="A bridge being loaded with the 2500lbs distributed across two areas."></img>
        <img tabindex="1" class="flex-object" alt="Example Construction" src="/SteelBridge/Construction.webp" title="Timed construction at the competition site."></img>
    </div>
</div>
...
<div class="flex-container" style="flex-direction: column;">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/EnvelopeSideView.webp" title="A side view of the bridge envelope, these are dimensional constraints that teams must design around."></img>
</div>
...
<div class="flex-container">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/ConstructionZone.webp" title="A bird's-eye view of the construction site.&#10;The west end is up top and the east end is below."></img>
</div>
...
<div class="flex-container" style="flex-direction: row;">
    ...
    <div class="flex-container flex-object" style="flex-direction: column;">
        <img tabindex="1" class="flex-object" src="/SteelBridge/Arch.webp" title="A typical arch design."></img>
        <img tabindex="1" class="flex-object" src="/SteelBridge/BottomDecking.webp" title="A typical under-decking design."></img>
        <img tabindex="1" class="flex-object" src="/SteelBridge/EnvelopeFrontView.webp" title="A front view of the envelope.&#10;Note that the allowed vertical space is greater if teams choose to extend into the arch region."></img>
    </div>
</div>
...
<div class="flex-container" style="flex-direction: row-reverse;">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/TransverseBeams.webp" title="An elevated front view of the bridge, showing the transverse beams which transfer the load from the beams to the arch."></img>
</div>
...
<div class="flex-container" style="flex-direction: column;">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/FloridaBridge.webp" title="UFL's 2024 bridge."></img>
</div>
...
<div class="flex-container" style="flex-direction: row;">
    ...
    <div class="flex-container flex-object" style="flex-direction: column;">
        <img tabindex="1" class="flex-object" src="/SteelBridge/ShearDiagram.webp" title="Shear diagram. X-axis is distance from the west end, Y-axis is shear force generated by competition loads."></img>
        <img tabindex="1" class="flex-object" src="/SteelBridge/GapView.webp" title="One of the arches, showing where the gap was placed."></img>
    </div>
</div>
...
<div class="flex-container" style="flex-direction: row-reverse;">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/Figure6FromPaper.webp" title="A figure from the paper, showing the tendency for optimized trusses to converge towards similar angles."></img>
</div>
<img tabindex="1" class="flex-object" src="/SteelBridge/SimilarAngles.webp" title="The designed trussing which incorporates the similar trussing angles described in the paper"></img>
...
<div class="flex-container" style="flex-direction: row;">
    ...
    <img tabindex="1" class="flex-object" src="/SteelBridge/SectionMcMasterCarr.webp" title="An example of a steel section that was used. Source: McMasterCarr"></img>
</div>
...
<img tabindex="1" class="flex-object" src="/SteelBridge/SapLinearAnalysis.webp" title="SAP2000's linear static analysis, which was used to optimize stiffness and weight."></img>
<div class="flex-container" style="flex-direction: row;">
    <p class="flex-object">
...
<div class="flex-container" style="flex-direction: column;">
    <p class="flex-object">
        ...
        <img tabindex="1" class="flex-object" src="/SteelBridge/PushoverCurves.webp" title="Two pushover curves, showing the failure points of two versions of the bridge. The x-axis is deflection (zero on the right), y-axis is load applied. The bridge is considered failed as soon as the deflection/load relationship becomes nonlinear."></img>
</div>
